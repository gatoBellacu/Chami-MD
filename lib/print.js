...
console.log(`┏━━━━━━━⊂(𝐂𝐔𝐑𝐈𝐎𝐒𝐈𝐓𝐘𝐁𝐎𝐓-𝐌𝐃)⊃━━━━━━━
┃☁️ ${chalk.redBright('%s')}\n║⏱️ㅤ${chalk.black(chalk.bgYellow('%s'))}ㅤ${chalk.black(chalk.bgGreen('%s'))}\n║🌠ㅤ${chalk.magenta('%s [%s %sB]')}
┃🟢ㅤ${chalk.green('%s')}\n║☂️ㅤ${chalk.yellow('%s%s')}\n║💌ㅤ${chalk.green('%s')}\n║🗨️ㅤ${chalk.black(chalk.bgYellow('%s'))}
┗━━━━━━━━━⊂(𝐂𝐔𝐑𝐈𝐎𝐒𝐈𝐓𝐘𝐁𝐎𝐓-𝐌𝐃)⊃━━━━━━━
`.trim(),
...
sender,
m ? m.exp : '?',
user ? '|' + user.exp + '|' + user.dorracoins : '' + ('|' + user.level + user.limit ),
m.chat + (chat ? ' ~' + chat : ''),
