...
const status = new Spinner(chalk.cyan(` Iniciando...`))
const starting = new Spinner(chalk.cyan(` Preparándose para conectar...`))
const reconnect = new Spinner(chalk.redBright(` Reconectando...`))

const connectToWhatsApp = async () => {
const conn = makeWASocket({
printQRInTerminal: true,
logger: logg({ level: 'fatal' }),
browser: ['Aurora-MD','Safari','1.0.0'],
auth: state
})
...
require('./conn')(conn, msg, m, Memory_Store)
})
...
conn.sendMessage(user_Call, { text: '¡Lo sentimos, fue detectado llamando al bot!\nEn 5 segundos,\nSera bloqueado automáticamente.'})
