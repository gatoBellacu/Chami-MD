...
conn.welcome = '*╭─❑* @subject *❑┈ ✦*\n*│✨ BIENVENIDO(A)!!*\n│❤️ @user\n│📄 *LEA LA DESCRIPCIÓN DEL GRUPO *\n*╰─────────────────────✦*\n ${ String . deCharCode ( 8206 ) . repetir ( 850 ) } \n@desc` }'
conn.bye = '*╭─────────────────❑*\n│ @user\n│ *SE FUE UN PRO, BYE!! 🙀*\n*╰─────────────────❏*' }'
conn.spromote = '*@user 𝒂𝒉𝒐𝒓𝒂 𝒆𝒔 𝒂𝒅𝒎𝒊𝒏 𝒅𝒆𝒍 𝒈𝒓𝒖𝒑𝒐 👑*'
conn.sdemote = '*@user 𝒚𝒂 𝒏𝒐 𝒆𝒔 𝒂𝒅𝒎𝒊𝒏 𝒅𝒆𝒍 𝒈𝒓𝒖𝒑𝒐 🙀*'
conn.sDesc = '*[⚠️] 𝒔𝒆 𝒉𝒂 𝒎𝒐𝒅𝒊𝒇𝒊𝒄𝒂𝒅𝒐 𝒍𝒂 𝒅𝒆𝒔𝒄𝒓𝒊𝒑𝒄𝒊𝒐𝒏 𝒅𝒆𝒍 𝒈𝒓𝒖𝒑𝒐*\n\n*𝒏𝒖𝒆𝒗𝒂 𝒅𝒆𝒔𝒄𝒓𝒊𝒑𝒄𝒊𝒐𝒏:* @desc'
conn.sSubject = '*[⚠️] 𝒔𝒆 𝒉𝒂 𝒎𝒐𝒅𝒊𝒇𝒊𝒄𝒂𝒅𝒐 𝒆𝒍 𝒏𝒐𝒎𝒃𝒓𝒆 𝒅𝒆𝒍 𝒈𝒓𝒖𝒑𝒐*\n*𝒏𝒖𝒆𝒗𝒐 𝒏𝒐𝒎𝒃𝒓𝒆:* @subject'
conn.sIcon = '*[⚠️] 𝒔𝒆 𝒉𝒂 𝒄𝒂𝒎𝒃𝒊𝒂𝒅𝒐 𝒍𝒂 𝒇𝒐𝒕𝒐 𝒅𝒆𝒍 𝒈𝒓𝒖𝒑𝒐*'
conn.sRevoke = '*[⚠️] 𝒔𝒆 𝒂 𝒂𝒄𝒕𝒖𝒂𝒍𝒊𝒛𝒂𝒅𝒐 𝒆𝒍 𝒍𝒊𝒏𝒌 𝒅𝒆𝒍 𝒈𝒓𝒖𝒑𝒐*\n*𝒏𝒖𝒆𝒗𝒐 𝒍𝒊𝒏𝒌:* @revoke'
...
console.log(chalk.cyanBright(`\n❑───────────[ AUTOCLEAR ]──────────────···\n│\n❑ BASURA 🚮 ELIMINADA DE LA CARPETA TMP\n│\n❑───────────────────────────────────────···\n`))
}, 180000)
_quickTest()
