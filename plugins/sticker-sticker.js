...
let handler = async (m, { conn, args, usedPrefix, command }) => {
  ...
  try {
    ...
    try {
      ...
      stiker = `*⚠️ La conversión ha fallado, intenta enviar primero imagen/video/gif y luego responde con el comando*`	
    }
  } finally {
    m.reply(stiker)
  }
...
stiker = await createSticker(false, args[0], '', author, 20)
} else throw `*⚠️ La conversión ha fallado, intenta enviar primero imagen/video/gif y luego responde con el comando ${usedPrefix + command}*`
} catch {
try {
