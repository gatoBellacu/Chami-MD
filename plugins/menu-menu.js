...
let td = `${pickRandom([d1,d2,d3,d4,d5,d6])}`
 ...
 const fload = {
    ...
    await conn.reply(m.chat, '◍᷒ᰰ᪶𖠵⃕⁖Ƈᴀʀɢᴀɴᴅᴏ, ᴀɢᴜᴀʀᴅᴇ ᴜɴ ᴍᴏᴍᴇɴᴛᴏ❞ ꔷ──᜔◇⃟̣̣⃕💦.*', ftrol) 
m.react('📌')     
let menu = `
...
└┬᯽⃟ᰳᰬᰶ┈⃐ 「  *sᴇʀᴠɪᴅᴏʀ ɪᴅ* 」
  .│
  .│ᨳ   ᮫ֻིꪰ˚ ⃛ ⃜. *Nombre:* ${name}
.  │ᨳ   ᮫ֻིꪰ˚ ⃛ ⃜  *Nivel:* ${level}
  .│ᨳ   ᮫ֻིꪰ˚ ⃛ ⃜  *Coins:*  ${money}
  .│ᨳ   ᮫ֻིꪰ˚ ⃛ ⃜  *Exp:* ${exp}
.  │ᨳ   ᮫ֻིꪰ˚ ⃛ ⃜  *Diamantes:* ${limit}
...
.  │ᨳ   ᮫ֻིꪰ˚ ⃛ ⃜ *Tiempo activo:*  ${uptime}
 . │ᨳ   ᮫ֻིꪰ˚ ⃛ ⃜ *Usuarios:* ${rtotalreg}
  .└┄̸࣭࣭࣭࣭࣭ٜ۫┄࣭࣭࣭۫┄̸࣭۫┄̸࣭࣭࣭࣭࣭ٜ۫┄࣭࣭࣭۫┄̸࣭۫┄̸࣭࣭࣭࣭࣭ٜ۫┄̸࣭࣭࣭࣭࣭ٜ۫┄࣭࣭࣭۫☪︎︎︎̸⃘̸࣭ٜ࣪࣪࣪۬◌⃘۪֟፝֯۫۫︎⃪𐇽۫۬🍧⃘⃪۪֟፝֯۫۫۫۬◌⃘࣭ٜ࣪࣪࣪۬☪︎︎︎︎̸┄̸࣭࣭࣭࣭࣭ٜ۫┈ ⳹
...
let buttonMessage = {
    ...
    'mimetype': td,
    'fileName': ' ଼. ⃝⃕☁️🅲ʀࣩࣩࣩᴇʏ͢s̷ࣩࣩࣩ𝖎͜ꦼ⃟🍡',
