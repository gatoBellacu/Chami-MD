...
if (/video/g.test(mime)) if ((q.msg || q).seconds > 11) return await this.sendButton(m.chat, '*⚠️ El vídeo no puede durar más de 10 segundos*', wm2, [['Desactivar autosticker', '/disable autosticker']], m)
let img = await q.download()
if (!img) return
