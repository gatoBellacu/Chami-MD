...
if (!effect) throw '*⚠️ ¿Cómo usar este comando?*\n_#logo (efecto) (texto)_\n*Ejemplo:*\n—◉ _#logo 3d-deep-sea-metal sityBot_\n\n*⚠️ Cuando les diga que falta un texto seria asi:*\n_#logo (efecto) (texto1|texto2)_\n*Ejemplo:*\n_#logo Wolf-Logo-Galaxy Sity|Bot_\n\n*<𝑳𝑰𝑺𝑻𝑨 𝑫𝑬 𝑬𝑭𝑬𝑪𝑻𝑶𝑺/>*\n\n° ඬ⃟📝 #logo ' + effects.map(v => v.title).join('\n° ඬ⃟📝 #logo ')
