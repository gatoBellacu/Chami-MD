...
await conn.sendButton(m.chat, `*「 𝐀𝐍𝐓𝐈 𝐋𝐈𝐍𝐊𝐒 」*\n*Hasta la próxima, ${await this.getName(m.sender)} Rompiste las reglas del grupo, serás exterminado...!!*${isBotAdmin ? '' : '\n\n*⚠️ el bot no es admin, no puedo hacer nada*'}`, author, ['𝙳𝙴𝚂𝙰𝙲𝚃𝙸𝚅𝙰𝚁 𝙰𝙽𝚃𝙸𝙻𝙸𝙽𝙺𝚂', '/disable antilink'], m)    
