...
└──────────────`, m)
  } else conn.reply(m.chat, `*⚠️ Lo siento, no tienes suficientes XP para comprar ${count} Diamantes💎*\n\n_Puedes conseguir *XP* usando los comandos del *menú juegos y economía*_`, m)
}
