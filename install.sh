...
echo -e "\033[1;35m"
git clone https://github.com/Azami19/CuriosityBotV1-MD.git
...
menu_ayuda() {
    #printf "${v1}[${b}++${v1}]${v} CuriosityBotV1-MD${b}: "
	read opcion
	case $opcion in
            01|1)
...
echo -e "\033[01;32m\033[01mIniciando CuriosityBotV1-MD!!\n\033[0m"
npm start
