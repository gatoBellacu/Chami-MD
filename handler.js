        ...
        for (let name in plugins) {
            ...
            if ((usedPrefix = (match[0] || '')[0])) {
                ...
                try {
                    ...
                    if (m.limit)
                        m.reply(+m.limit + 'Gastaste 10 Coins!\n Para ver cuantas Coins te quedan, envia /coins')
                }
                break
            }
        }
            ...
            if (chat.welcome) {
                ...
                for (let user of participants) {
                    ...
                    try {
                        ...
                        text = (action === 'add' ? (chat.sWelcome || this.welcome || Connection.conn.welcome || 'Hola, @user!\n Bienvenido a @subject!!\n\nLee las reglas\n\n@desc').replace('@subject', await this.getName(id)).replace('@desc', groupMetadata.desc?.toString() || 'unknow') :
